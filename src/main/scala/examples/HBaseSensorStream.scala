...
object HBaseSensorStream extends Serializable {
  ...
  def main(args: Array[String]): Unit = {
    ...
    jobConfig.set("mapreduce.output.fileoutputformat.outputdir", "/user/mapr/sparkhbasestreamout")
    ...
    val sensorDStream = ssc.textFileStream("/user/mapr/sparkhbasestream").map(Sensor.parseSensor)
    sensorDStream.print()
